...
test_lib:
	...
	#crasm test/lib/test_sound_play.s -o test/lib/test_sound_play.srec > test/lib/test_sound_play.lst && objcopy -I srec -O binary test/lib/test_sound_play.srec test/lib/test_sound_play.bin && run6502 -l 8000 test/lib/test_sound_play.bin -M fff9 -X 0 > test/lib/actual_sound_play_out.bin && diff test/lib/expected_sound_play_out.bin test/lib/actual_sound_play_out.bin
